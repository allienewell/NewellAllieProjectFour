...
namespace NewellAllieFinalProject {
    ...
    public partial class CoursesDataSet : global::System.Data.DataSet {
        ...
        public partial class CoursesDataTable : global::System.Data.TypedTableBase<CoursesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CoursesRow AddCoursesRow(string CourseNo, string CourseName) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CoursesRow FindByCourseNo(string CourseNo) {
        ...
        public partial class CoursesRow : global::System.Data.DataRow {
            ...
            public string CourseNo {
                get {
                    return ((string)(this[this.tableCourses.CourseNoColumn]));
                }
                set {
                    this[this.tableCourses.CourseNoColumn] = value;
                }
            }
...
namespace NewellAllieFinalProject.CoursesDataSetTableAdapters {
    ...
    public partial class CoursesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Courses] WHERE (([CourseNo] = @Original_CourseNo) AND ((@IsNul" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Courses] ([CourseNo], [CourseName]) VALUES (@CourseNo, @Course" +
                "Name);\r\nSELECT CourseNo, CourseName FROM Courses WHERE (CourseNo = @CourseNo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Courses] SET [CourseNo] = @CourseNo, [CourseName] = @CourseName WHERE (([CourseNo] = @Original_CourseNo) AND ((@IsNull_CourseName = 1 AND [CourseName] IS NULL) OR ([CourseName] = @Original_CourseName)));
SELECT CourseNo, CourseName FROM Courses WHERE (CourseNo = @CourseNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NewellAllieFinalProject.Properties.Settings.Default.CoursesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CourseNo, CourseName FROM dbo.Courses";
        ...
        public virtual int Delete(string Original_CourseNo, string Original_CourseName) {
        ...
        public virtual int Insert(string CourseNo, string CourseName) {
            if ((CourseNo == null)) {
        ...
        public virtual int Update(string CourseNo, string CourseName, string Original_CourseNo, string Original_CourseName) {
            if ((CourseNo == null)) {
                throw new global::System.ArgumentNullException("CourseNo");
            }
            else {
            ...
            if ((Original_CourseNo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_CourseNo));
            }
            if ((Original_CourseName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CourseName, string Original_CourseNo, string Original_CourseName) {
            return this.Update(Original_CourseNo, CourseName, Original_CourseNo, Original_CourseName);
        }
    }
